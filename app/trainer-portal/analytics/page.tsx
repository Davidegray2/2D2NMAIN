        ...
        <main>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Track your client's progress and performance</p>
            </div>
          </div>
          ...
          <Card className="h-[400px] flex items-center justify-center">
            <CardContent className="text-center">
              ...
              <p className="text-muted-foreground">Connect your clients' wearables to track their progress</p>
            </CardContent>
          </Card>
        </main>
      </div>
