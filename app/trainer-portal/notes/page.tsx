        ...
        <main>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Manage your client notes</p>
            </div>
          </div>
          ...
          <Card className="h-[400px] flex items-center justify-center">
            <CardContent className="text-center">
              ...
              <h3 className="text-lg font-medium mb-2">No notes selected</h3>
              <p className="text-muted-foreground">Select a client to view their notes</p>
            </CardContent>
          </Card>
        </main>
      </div>
